...
tokenizer1 = AutoTokenizer.from_pretrained("./rnafm-fast-tokenizer") 
...
def tokenize_and_align(example):
    ...
    tokens = tokenizer(
        example["text"],
        truncation=True  #,padding='max_length', max_length=15  
    )   
...
trainer.train()
trainer.save_model('rna-fm-finetuned-for-token-classification')